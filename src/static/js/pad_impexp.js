...
const padimpexp = (function () {
  ...
  // used in pad.html
  const importSuccessful = (token) => { // eslint-disable-line
    $.ajax(
        {
          type: 'post',
          ...
          success: importApplicationSuccessful, // eslint error; no-undef
  ...
  const importApplicationFailed = (xhr, textStatus, errorThrown) => {
